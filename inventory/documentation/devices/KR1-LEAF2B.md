...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_KR1-SPINE1_Ethernet4 | routed | - | 10.172.0.13/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_KR1-SPINE2_Ethernet4 | routed | - | 10.172.0.15/31 | default | 1500 | false | - | - |
...
| 10.172.0.12 | 65001 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
| 10.172.0.14 | 65001 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
| 10.192.1.4 | Inherited from peer group MLAG | default | - | Inherited from peer group MLAG | Inherited from peer group MLAG | - | - |
...
router bgp 65102
   ...
   neighbor 10.172.0.12 peer group Underlay
   neighbor 10.172.0.12 remote-as 65001
   neighbor 10.172.0.12 description KR1-SPINE1_Ethernet4
   neighbor 10.172.0.14 peer group Underlay
   neighbor 10.172.0.14 remote-as 65001
   neighbor 10.172.0.14 description KR1-SPINE2_Ethernet4
   neighbor 10.192.1.4 peer group MLAG
   neighbor 10.192.1.4 description KR1-LEAF2A

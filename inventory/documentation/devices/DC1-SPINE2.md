...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-LEAF1A_Ethernet2 | routed | - | 10.172.0.2/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-LEAF1B_Ethernet2 | routed | - | 10.172.0.6/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2A_Ethernet2 | routed | - | 10.172.0.10/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF2B_Ethernet2 | routed | - | 10.172.0.14/31 | default | 1500 | false | - | - |
...
| 10.172.0.3 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 10.172.0.7 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 10.172.0.11 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 10.172.0.15 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
router bgp 65001
   ...
   neighbor 10.172.0.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.172.0.3 remote-as 65101
   neighbor 10.172.0.3 description DC1-LEAF1A_Ethernet2
   neighbor 10.172.0.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.172.0.7 remote-as 65101
   neighbor 10.172.0.7 description DC1-LEAF1B_Ethernet2
   neighbor 10.172.0.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.172.0.11 remote-as 65102
   neighbor 10.172.0.11 description DC1-LEAF2A_Ethernet2
   neighbor 10.172.0.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.172.0.15 remote-as 65102
   neighbor 10.172.0.15 description DC1-LEAF2B_Ethernet2

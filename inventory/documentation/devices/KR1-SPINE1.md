...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.183.0.11/24 | 10.183.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_KR1-LEAF1A_Ethernet1 | routed | - | 10.172.0.0/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_KR1-LEAF1B_Ethernet1 | routed | - | 10.172.0.4/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_KR1-LEAF2A_Ethernet1 | routed | - | 10.172.0.8/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_KR1-LEAF2B_Ethernet1 | routed | - | 10.172.0.12/31 | default | 1500 | false | - | - |
...
| 10.172.0.1 | 65101 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
| 10.172.0.5 | 65101 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
| 10.172.0.9 | 65102 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
| 10.172.0.13 | 65102 | default | - | Inherited from peer group Underlay | Inherited from peer group Underlay | - | - |
...
router bgp 65001
   ...
   neighbor 10.172.0.1 peer group Underlay
   neighbor 10.172.0.1 remote-as 65101
   neighbor 10.172.0.1 description KR1-LEAF1A_Ethernet1
   neighbor 10.172.0.5 peer group Underlay
   neighbor 10.172.0.5 remote-as 65101
   neighbor 10.172.0.5 description KR1-LEAF1B_Ethernet1
   neighbor 10.172.0.9 peer group Underlay
   neighbor 10.172.0.9 remote-as 65102
   neighbor 10.172.0.9 description KR1-LEAF2A_Ethernet1
   neighbor 10.172.0.13 peer group Underlay
   neighbor 10.172.0.13 remote-as 65102
   neighbor 10.172.0.13 description KR1-LEAF2B_Ethernet1
